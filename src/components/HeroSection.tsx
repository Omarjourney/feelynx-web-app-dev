    ...
    <div className="relative bg-gradient-hero py-20 px-4 text-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-4xl">
        ...
        <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
          Experience premium adult entertainment with interactive features, live streaming, and
          exclusive content from top creators worldwide.
        </p>

        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <Button
            size="lg"
            className="bg-white text-purple-600 hover:bg-white/90 px-8 py-3 rounded-full font-semibold"
          >
            Start Exploring
          </Button>
          <Button
