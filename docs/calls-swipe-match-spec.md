...
The Calls section transforms into a swipable, match-driven experience that combines creator discovery with instant video/voice connections. Inspired by Feelynx and Who, users swipe through dynamic profile cards, match in real time, and jump into social calls with token-based billing.
