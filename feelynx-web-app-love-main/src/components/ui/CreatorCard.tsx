...
export const CreatorCard = ({ name, live, thumbnail, earnings, onSelect }: CreatorCardProps) => {
  return (
    <article className="glass-card h-full overflow-hidden rounded-3xl text-foreground transition hover:bg-white/10">
      <button
        type="button"
        onClick={onSelect}
        className="flex h-full w-full flex-col text-left focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/40"
