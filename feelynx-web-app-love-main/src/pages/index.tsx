...
const onboardingTips: OnboardingTip[] = [
  {
    ...
    onAction: () => console.log('Opening studio setup checklist'),
  },
  {
    ...
    onAction: () => console.log('Scheduling a welcome stream'),
  },
  {
    ...
    onAction: () => console.log('Building a fan crew'),
  },
];
...
const Index = () => {
  ...
  const handleRecharge = () => {
    console.log('Recharge VibeCoins CTA');
  };

  const handleWithdraw = () => {
    console.log('Withdraw funds CTA');
  };
  ...
  return (
    <div className="space-y-10 pb-20">
      ...
      <HomeLayout
        ...
        balance={{ coins: 2547, usdValue: 25.47, onRecharge: handleRecharge, onWithdraw: handleWithdraw }}
