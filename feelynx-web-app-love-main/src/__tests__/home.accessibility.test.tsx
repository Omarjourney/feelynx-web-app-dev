    ...
    const { container, root } = render(
      <MemoryRouter>
        <HomeLayout
          creators={creators}
          crews={[
            { name: 'Vibe Circle', description: 'Daily check-ins with your top fans.', memberCount: 120 },
            { name: 'Night Owls', description: 'Late-night talk shows and playlists.', memberCount: 87 },
          ]}
          vibeCoinOptions={[
            { amount: '500', price: '$5' },
            { amount: '1000', price: '$9' },
